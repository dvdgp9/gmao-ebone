...
use App\Controllers\UsuariMassiuController;
...
$router->post('usuaris/massiu', UsuariMassiuController::class, 'executar');
$router->post('usuaris/exportar', UsuariMassiuController::class, 'exportar');
