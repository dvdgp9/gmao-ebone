...
<form method="POST" action="<?= $action ?>" class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Codi del pla</label>
                <input type="text" name="codi" maxlength="50" value="<?= e($tasca['codi'] ?? '') ?>"
                       placeholder="p. ex. 1 o MAT-001"
